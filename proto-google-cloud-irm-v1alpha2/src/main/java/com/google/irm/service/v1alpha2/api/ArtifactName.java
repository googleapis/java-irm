...
public class ArtifactName implements ResourceName {
  ...
  public static ArtifactName of(String project, String incident, String artifact) {
    return newBuilder().setProject(project).setIncident(incident).setArtifact(artifact).build();
  }

  public static String format(String project, String incident, String artifact) {
    return newBuilder()
        .setProject(project)
  ...
  public static ArtifactName parse(String formattedString) {
    ...
    return of(matchMap.get("project"), matchMap.get("incident"), matchMap.get("artifact"));
  }
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate(
        "project", project, "incident", incident, "artifact", artifact);
  }

  /** Builder for ArtifactName. */
  public static class Builder {
    ...
    private Builder(ArtifactName artifactName) {
      ...
      incident = artifactName.incident;
