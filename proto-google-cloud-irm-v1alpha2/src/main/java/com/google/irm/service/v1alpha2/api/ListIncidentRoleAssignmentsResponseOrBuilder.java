...
public interface ListIncidentRoleAssignmentsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.irm.v1alpha2.ListIncidentRoleAssignmentsResponse)
   ...
   * </code>
   */
  java.util.List<com.google.irm.service.v1alpha2.api.IncidentRoleAssignment>
   ...
   * </code>
   */
  com.google.irm.service.v1alpha2.api.IncidentRoleAssignment getIncidentRoleAssignments(int index);
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  int getIncidentRoleAssignmentsCount();
  /**
   *
   *
   * <pre>
