...
public interface SearchSimilarIncidentsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.irm.v1alpha2.SearchSimilarIncidentsResponse)
   ...
   * </code>
   */
  java.util.List<com.google.irm.service.v1alpha2.api.SearchSimilarIncidentsResponse.Result>
      getResultsList();
  /**
   *
   *
   ...
   * </code>
   */
  com.google.irm.service.v1alpha2.api.SearchSimilarIncidentsResponse.Result getResults(int index);
  /**
   *
   *
   * <pre>
